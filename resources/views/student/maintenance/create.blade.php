                ...
                <div class="card-body">
                    <form id="maintenanceForm" action="{{ route('student.maintenance.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" rows="4" class="form-control @error('description') is-invalid @enderror" placeholder="{{ __('Please provide specific details about the issue...') }}" required>{{ old('description') }}</textarea>
