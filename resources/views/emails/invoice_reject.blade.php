...
<head>
    ...
    <title>رفض الدفع - بوابة الإسكان الجامعي</title>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1 style="margin:0;font-size:24px;">رفض الدفع</h1>
        </div>
        
        <div class="content">
            <img src="https://es.nmu.edu.eg/housing/images/email/rejected.svg" alt="Rejected" title="Rejected" class="centered-image">

            <h2 style="color:#1e293b;margin-top:0;">مرحباً {{ $user->first_name_ar .' '.$user->last_name_ar }}،</h2>
            <p>نأسف لإبلاغك بأن عملية الدفع الخاصة بحجزك في السكن الجامعي بجامعة المنصورة الجديدة قد تم رفضها.</p>
