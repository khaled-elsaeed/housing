...
class BuildingController extends Controller
{
            ...
            return response()->json([
                ...
                'data' => $buildings->map(function ($building) {
                    return [
                        ...
                        'actions' =>
                            '
                        <button type="button" class="btn btn-round btn-warning-rgba" id="edit-note-btn-' .
                            $building->id .
                            '" title="Edit Note">
                            <i class="feather icon-edit"></i>
                        </button>
                        <button type="button" class="btn btn-round btn-primary-rgba" id="edit-status-btn-' .
                            $building->id .
                            '" title="Edit Status">
                            <i class="feather icon-settings"></i>
                        </button>
                        <button type="button" class="btn btn-round btn-danger-rgba" id="delete-btn-' .
                            $building->id .
    ...
    {
        $emptyBuildings = Building::with([
            'apartments.rooms' => function ($query) {
                $query
