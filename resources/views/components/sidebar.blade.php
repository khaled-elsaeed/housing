...
<div class="sidebar">
                ...
                <div class="navigationbar">
                    ...
                    <li>
                            ...
                            <img src="{{ asset('images/svg-icon/dashboard.svg') }}" class="img-fluid" alt="dashboard"><span>Dashboard</span><i class="feather"></i>
                            </a>
                        </li>    
                        ...
                        <li>
                            ...
                            <ul class="vertical-submenu">
                                <li><a href="apps-Calender.html">calendar</a></li>
                        ...
                        <li>
                            <a href="javaScript:void();">
                                <img src="{{ asset('images/svg-icon/chart.svg') }}" class="img-fluid" alt="chart"><span>Charts</span><i class="feather icon-chevron-right pull-right"></i>
                            </a>
                            <ul class="vertical-submenu">
                        ...
                        <li>
                            <a href="javaScript:void();">
                                <img src="{{ asset('images/svg-icon/icons.svg') }}" class="img-fluid" alt="icons"><span>Icons</span><i class="feather icon-chevron-right pull-right"></i>
                            </a>
                            <ul class="vertical-submenu">
                        ...
                        <li>
                            <a href="javaScript:void();">
                                <img src="{{ asset('images/svg-icon/tables.svg') }}" class="img-fluid" alt="tables"><span>Tables</span><i class="feather icon-chevron-right pull-right"></i>
                            </a>
                            <ul class="vertical-submenu">
                        ...
                        <li>
                            <a href="javaScript:void();">
                                <img src="{{ asset('images/svg-icon/maps.svg') }}" class="img-fluid" alt="maps"><span>Maps</span><i class="feather icon-chevron-right pull-right"></i>
                            </a>
                            <ul class="vertical-submenu">
                        ...
                        <li>
                            <a href="widgets.html">
                                <img src="{{ asset('images/svg-icon/widgets.svg') }}" class="img-fluid" alt="widgets"><span>Widgets</span><span class="badge badge-success pull-right">New</span>
                            </a>
                        </li>                        
                        <li>
                            <a href="javaScript:void();">
                              <img src="{{ asset('images/svg-icon/pages.svg') }}"
                              class="img-fluid" alt="pages"><span>Pages</span><i class="feather icon-chevron-right pull-right"></i>
                            </a>
                            <ul class="vertical-submenu">
                                <li>
                        ...
                        <li>
                            <a href="javaScript:void();">
                                <img src="{{ asset('images/svg-icon/ecommerce.svg') }}" class="img-fluid" alt="ecommerce"><span>eCommerce</span><i class="feather icon-chevron-right pull-right"></i>
                            </a>
                            <ul class="vertical-submenu">
