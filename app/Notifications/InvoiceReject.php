...
class InvoiceReject extends Notification
{
    ...
    {   
        ...
        Log::info('InvoiceReject Notification: Invoice object received', [
    ...
    {
        // Log before creating the InvoiceRejectMailable
        Log::info('InvoiceReject Notification: Preparing to send email', [
            'invoice_id' => $this->invoice->id,
