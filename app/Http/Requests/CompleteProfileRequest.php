...
class CompleteProfileRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            "academicId" => ["nullable", "string", "size:9"],
            "academicEmail" => [
                "nullable",
                "email",
                "max:255",
    ...
    public function messages()
    {
        return [
            ...
            "nameEn.regex" =>
                "The English name must contain only English characters.",
            "nationalId.size" => "The national ID must be exactly 14 digits.",
            "nationalId.regex" =>
                "The national ID format is invalid. It must start with 2 or 3 followed by 13 digits.",
            "phone.regex" =>
                "The phone number must be a valid Egyptian phone number.",
            "parentPhone.regex" =>
                "The parent phone number must be a valid Egyptian phone number.",
            "emergencyContactPhone.regex" =>
                "The emergency contact phone number must be a valid Egyptian phone number.",
            "score.regex" =>
                "The score must have 0 more than 2 decimal places.",
            "siblingNationalId.regex" =>
                "The sibling national ID format is invalid. It must start with 2 or 3 followed by 13 digits.",
